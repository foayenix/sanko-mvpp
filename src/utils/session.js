const { getSession, getExpiredSession, upsertSession, clearSession } = require('../services/supabase');

async function getActiveSession(practitioner_id) {
  return getSession(practitioner_id);
}

async function getTimedOutSession(practitioner_id) {
  return getExpiredSession(practitioner_id);
}
...
module.exports = { getActiveSession, getTimedOutSession, setSession, endSession };
